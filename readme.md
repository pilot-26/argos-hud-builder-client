...
ARGOS HUD Builder follows a client-server architecture, where the client instance manages windows and user interactions and the server instance runs in the background to handle the communication between your HOTASes and handles DirectInput emulation.
ARGOS HUD Builder can be run in Client mode, Server Mode, or combined.
